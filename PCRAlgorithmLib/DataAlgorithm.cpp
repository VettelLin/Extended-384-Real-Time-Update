...
CDataAlgorithm::CDataAlgorithm(void)
{
}
...
void CDataAlgorithm::Alspl(double x0,double h,int n,double *y,int k,double t, double *s)
//double t,x0,h,y[],s[5];
{ 
	int kk,m,l;
	double u[5],p,q;
...
void CDataAlgorithm::Amspl(double *x,double *y,int n,double *dy,double *ddy)
{
	int j;
...
void CDataAlgorithm::Jbsqt(double *x,double *y,int n,double *a,double *dt)
// double x[],y[],a[2],dt[6];
{
	int i;
...
void CDataAlgorithm::Kdspt(int n, double *y, double *yy)
{
	//五点三次平滑滤波
	int i;
    if (n<5)
...
void CDataAlgorithm::Kdspt7_3(int n, double *y, double *yy)
{
	//七点三次平滑滤波
	int i;
	if (n<7)
...
void CDataAlgorithm::Kdspt5_2(int n,double *y,double *yy)
{
	//五点两次平滑滤波
	int i;
	if ( n < 5 )
...
void CDataAlgorithm::Kdspt7_2(int n,double *y,double *yy)
{
	//七点二次平滑滤波
	int i;
	if ( n < 7 )
...
void CDataAlgorithm::Kdspt_dtmean(int n,int dtnum,double *y,double *yy)
{
	//滑动平均滤波 dtnum(滑动窗口)
	int i;
	int k;
...
void CDataAlgorithm::Kdspt_Median(int n,int cfnum,double *y,double *yy)
{
	//中位数滤波 cfnum(窗口)
	int i;
	int k;
 ...
 * \param *pOutput 
 */
void CDataAlgorithm::SortDouble(int nNum, double *pInput, double *pOutput)
{
	int sType = 3;
...
void CDataAlgorithm::Kdspt_cfmean(int n, int cfnum, double *y, double *yy)
{
...
void CDataAlgorithm::Kdspt_TriangularSmooths_29(int n,double *y,double *yy)
{
...
void CDataAlgorithm::Kdspt_GaussianSmooths_31(int n,double *y,double *yy)
{
...
void CDataAlgorithm:: Akspl(double *x,double *y,int n,int k,double t,double *s,bool bSpline)
//double t,x[],y[],s[5];
{
	int kk,m,l;
    double u[5],p,q;
...
void CDataAlgorithm::AksplEx(double *x,double *y,int n,int k,double t,double *s,bool bSpline)
	//double t,x[],y[],s[5];
{
	int kk,m,l;
	double u[5],p,q;
...
int CDataAlgorithm::Dginv(double *a,int m,int n,double *aa,double eps,double *u,double *v,int ka)
{
	int i,j,k,l,t,p,q,f;
	double *at;
	at = new double [m*n];
...
int CDataAlgorithm::Dluav(double *a,int m,int n,double *u,double *v,double eps,int ka)
{
...
void CDataAlgorithm::Ppp(double *a,double *e,double *s,double *v,int m,int n)
  {
	  int i,j,p,q;
	  double d;
	  if (m>=n) i=n;
...
void CDataAlgorithm::Sss(double *fg,double *cs)
{
	double r,d;
...
void CDataAlgorithm::Damul(double *a,double *b,int m,int n,int k,double *c)
{
	int i,j,l,u;
    for (i=0; i<=m-1; i++)
		for (j=0; j<=k-1; j++)
