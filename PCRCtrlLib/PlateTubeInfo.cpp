...
CString CPlateTubeInfo::CreateTubeLabel(int iIndex)
{
	...
	//xzq:注释
	/*int Quotient = (iIndex - 1) / 12;
	int Remainder = iIndex % 12;
	...
	int Quotient = (iIndex - 1) / 6;
	int Remainder = iIndex % 6;
	...
	strLable.Format(_T("%c%d"), cLabel + Quotient, Remainder);
